...
class ServiceBase(metaclass=ABCMeta):
    ...
    @abstractmethod
    @classmethod
    def filterPresentRelatedRule(cls, rule):
        pass

    @abstractmethod
    @classmethod
    def getDependencyKeysInRule(cls, rule):
        pass

    @abstractmethod
    @classmethod
    def getValidationErrorTemplateMessages(cls):
        pass

    @abstractmethod
    @classmethod
    def getValidationErrors(cls, data, ruleLists, names, messages):
        pass

    @abstractmethod
    @classmethod
    def hasArrayObjectRuleInRuleList(cls, ruleList):
        pass

    @abstractmethod
    @classmethod
    def removeDependencyKeySymbolInRule(cls, rule):
        pass

    @abstractmethod
    def getResponseBody(self, rule):
        pass
